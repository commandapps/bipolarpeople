  ...
  try {
    ...
    const result = await sql.query(
      ...
      [
        ...
        body.episode_type,
        body.plan_name,
        body.warning_signs && body.warning_signs.length > 0 ? body.warning_signs : null,
        body.triggers && body.triggers.length > 0 ? body.triggers : null,
        body.coping_strategies && body.coping_strategies.length > 0 ? body.coping_strategies : null,
        body.helpful_activities && body.helpful_activities.length > 0 ? body.helpful_activities : null,
        body.things_to_avoid && body.things_to_avoid.length > 0 ? body.things_to_avoid : null,
        body.emergency_contacts && body.emergency_contacts.length > 0 ? body.emergency_contacts : null,
        body.support_people && body.support_people.length > 0 ? body.support_people : null,
        body.therapy_plan || null,
        body.medication_plan || null,
        body.current_medications && body.current_medications.length > 0 ? body.current_medications : null,
